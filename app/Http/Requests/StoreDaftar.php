...
class StoreDaftar extends FormRequest
{
    ...
    public function rules()
    {
        ...
        if ($jenis == '0') {
            return [
                'anggota_jenis_id' => 'required|exists:mysql2.ref_anggota_jenis,id',
                ...
                'email' => 'required|email|unique:mysql2.trn_pendaftaran|unique:mysql2.ref_pendaftar',
                'email_pic' => 'required|email',
                'website' => 'nullable|url',
                'telp_no1' => 'required|numeric|unique:mysql2.trn_pendaftaran',
                'telp_no2' => 'nullable|numeric|unique:mysql2.trn_pendaftaran',
                'fax_no1' => 'nullable|numeric|unique:mysql2.trn_pendaftaran',
                'fax_no2' => 'nullable|numeric|unique:mysql2.trn_pendaftaran',
                'nib' => 'required',
            ...
            return [
                ...
                'perusahaan_id' => 'required|exists:mysql2.ref_anggota,nama_lengkap',
                'pejabat_jabatan' => 'required|regex:/^[a-zA-Z.\/()\- ]*$/',
                'provinsi_id' => 'required|exists:mysql2.ref_provinsi,id',
                'kabupaten_id' => 'required|exists:mysql2.ref_kabupaten,id',
                'kecamatan_id' => 'required|exists:mysql2.ref_kecamatan,id',
                ...
                'identitas_kelurahan_id' => 'required|exists:mysql2.ref_kelurahan,id',
                'identitas_alamat' => 'required|regex:/^[a-zA-Z0-9.\/()\- ]*$/',
                'email' => 'required|email|unique:mysql2.trn_pendaftaran',
                'email_pic' => 'required|email',
                'website' => 'nullable|url',
                'telp_no1' => 'required|numeric|unique:mysql2.trn_pendaftaran',
                'telp_no2' => 'nullable|numeric|unique:mysql2.trn_pendaftaran',
