...
class StoreDaftarNonAnggota extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'telp_no1' => 'required|numeric|unique:mysql2.ref_pendaftar',
            'telp_no2' => 'nullable|numeric|unique:mysql2.ref_pendaftar',
            'fax_no1' => 'nullable|numeric|unique:mysql2.ref_pendaftar',
            'fax_no2' => 'nullable|numeric|unique:mysql2.ref_pendaftar',
            'nik' => 'required|numeric|unique:mysql2.ref_pendaftar',
